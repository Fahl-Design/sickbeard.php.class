...
class sb {
	...
	function showlist() 
	{
		...
		foreach($sbJSON->{data} as $show) {
			...
			echo '<a href="#'.$show->{tvdbid}.'" data-rel="popup" data-position-to="window" data-transition="fade"><img class="popphoto" src="'.$sbh->url_banner($show->{tvdbid}).'" alt="'.$show->{show_name}.'"></a><br>';
